...
To work on `gamma-lake`, you are going to need to build it from source. See
[Build from Source](Build-from-Source) for
detailed build instructions.

Once you've built `gamma-lake` from a `git` clone, you will also need to
configure `git` and your GitHub account for `gamma-lake` development.

## Step 2: Configuring Git and GitHub for Development

### Create your fork

The first step is to create a personal fork of `gamma-lake`. To do so, click
the "fork" button at https://github.com/Point72/gamma-lake, or just navigate
[here](https://github.com/Point72/gamma-lake/fork) in your browser. Set the
