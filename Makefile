...
lint-py:  ## lint python with ruff
	python -m ruff check gamma_lake
	python -m ruff format --check gamma_lake
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix gamma_lake
	python -m ruff format gamma_lake
...
test:  ## run python tests
	python -m pytest -v gamma_lake/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v gamma_lake/tests --cov=gamma_lake --cov-report term-missing --cov-report xml
